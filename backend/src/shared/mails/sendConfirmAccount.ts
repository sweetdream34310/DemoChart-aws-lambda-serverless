...
export function template(params: any){
    ...
    <a href="${LANDING_PAGE_URL}/thank-you?code={####}&username=${params.firstName}" style="
    color: white;
    text-decoration: none;">Confirm now</a>
...
export const confirmAccountTemplate = (params: any) => combineTemplates(template, params);

/**
 * Not used in this case as we intercept with aws cognito
 */
// export default async function sendConfirmAccount(email: string, params: any) {
//     return sendMail(email, 'You are one step away...', combineTemplates(template, params))
// }