...
import {anInternalErrorResponse, genericResponse, startupRoutine} from "../shared/helpers";
...
/**
 * For some reason, it does not work to import this script from shared/helpers/ActiveCampaign.ts
 */
// const apiKey = 'e2350f47a2da283d5d2dadaaf7ae0a5ee277507743f44493a047311f1d73dedc3054814a';
// const instance = axios.create({
// 	baseURL: 'http://democharts.api-us1.com/',
// 	timeout: 30000,
// 	headers: {
// 		'Accept': 'application/json',
// 		'Content-Type': 'application/json',
